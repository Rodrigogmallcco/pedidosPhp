...
Route::get('clientes/{nombrePersona}/productos-pedidos', [UsuarioController::class,'listarProductos']);
Route::put('/update/{detalle_id}', [pedidoController::class,'actualizarEstado']);
Route::post('/subir/{detalle_id}', [pedidoController::class,'subirArchivo']);
